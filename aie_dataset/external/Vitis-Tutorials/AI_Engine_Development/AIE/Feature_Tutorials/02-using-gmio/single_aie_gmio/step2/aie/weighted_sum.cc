...
PATH: AI_Engine_Development/AIE/Feature_Tutorials/02-using-gmio/single_aie_gmio/step2/aie/weighted_sum.cc
DOMAIN: GMIO / Data Movement
INTERFACE: Window
KEY INTRINSICS: aie::vector_decl_align, aie::begin_vector, aie::vector, aie::load_v, aie::sliding_mul
VECTOR TYPES: aie::vector<int32,8>, aie::vector<int32,16>
*/
