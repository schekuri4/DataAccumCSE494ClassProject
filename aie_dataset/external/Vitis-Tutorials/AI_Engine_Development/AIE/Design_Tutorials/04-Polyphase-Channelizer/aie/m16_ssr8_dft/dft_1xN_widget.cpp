...
PATH: AI_Engine_Development/AIE/Design_Tutorials/04-Polyphase-Channelizer/aie/m16_ssr8_dft/dft_1xN_widget.cpp
DOMAIN: DSP — FFT / Channelizer
INTERFACE: Stream, Cascade
KEY INTRINSICS: aie::set_rounding, aie::rounding_mode, aie::set_saturation, aie::saturation_mode, aie::cbegin_vector_circular, aie::vector, aie::zeros, aie::accum, aie::concat, aie::sliding_mul_ops, readincr_v4, writeincr
VECTOR TYPES: aie::vector<TT_DATA,8>, aie::vector<TT_COEFF,16>, aie::accum<TT_ACC,4>
*/
