...
PATH: AI_Engine_Development/AIE/Design_Tutorials/04-Polyphase-Channelizer/aie/m16_ssr8_filterbank/m16_ssr8_filterbank_only_graph.h
DOMAIN: DSP — FIR / Filtering
INTERFACE: Stream, PLIO/GMIO
KEY INTRINSICS: connect, location
