...
PATH: AI_Engine_Development/AIE/Design_Tutorials/04-Polyphase-Channelizer/aie/m16_ssr8_filterbank/polyphase_fir.h
DOMAIN: DSP — FIR / Filtering
INTERFACE: Stream
KEY INTRINSICS: aie::vector, readincr, mul4, mac4, srs, bank, tile
VECTOR TYPES: aie::vector<TT_DATA,TAPS_PER_PHASE>, v16int16
*/
