/*
SOURCE: pjh177787/my_mlir-aie, branch main
PATH: programming_examples/ml/block_datatypes/bfp_conversion/kernel.cc
DOMAIN: AIE Source
INTERFACE: Window
KEY INTRINSICS: aie::vector, aie::load_v, aie::block_vector, aie::block_vector_input_buffer_stream, aie::accum, aie::block_vector_output_buffer_stream, aie::detail
VECTOR TYPES: aie::vector<bfloat16,64>, aie::accum<accfloat,64>, v8bfp16ebs8, v16bfp16ebs16
*/
