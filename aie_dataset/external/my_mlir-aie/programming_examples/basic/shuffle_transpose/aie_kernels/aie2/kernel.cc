...
PATH: programming_examples/basic/shuffle_transpose/aie_kernels/aie2/kernel.cc
DOMAIN: AIE Source
INTERFACE: Unknown
KEY INTRINSICS: aie::load_v, aie::vector, aie::store_v
VECTOR TYPES: aie::vector<uint8_t,64>
*/
