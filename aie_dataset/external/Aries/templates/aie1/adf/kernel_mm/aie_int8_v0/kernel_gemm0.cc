...
PATH: templates/aie1/adf/kernel_mm/aie_int8_v0/kernel_gemm0.cc
DOMAIN: Matrix Operations / Linear Algebra
INTERFACE: Window
KEY INTRINSICS: aie::vector, aie::load_v, aie::accum, aie::store_v
VECTOR TYPES: aie::vector<int8,32>, aie::vector<int8,64>, aie::vector<int8,16>, aie::accum<acc48,16>, v16acc48
*/
