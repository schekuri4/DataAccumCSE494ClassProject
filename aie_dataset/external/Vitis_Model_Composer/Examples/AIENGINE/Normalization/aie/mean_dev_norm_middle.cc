...
PATH: Examples/AIENGINE/Normalization/aie/mean_dev_norm_middle.cc
DOMAIN: AIE Source
INTERFACE: Window, Stream, Cascade
KEY INTRINSICS: aie::vector_decl_align, aie::begin_vector, aie::accum, aie::load_v, aie::add, aie::vector, aie::broadcast, aie::sub, aie::mul, aie::div, readincr, writeincr
