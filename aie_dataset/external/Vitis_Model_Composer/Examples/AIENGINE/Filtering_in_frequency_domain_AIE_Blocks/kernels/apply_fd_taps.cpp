...
PATH: Examples/AIENGINE/Filtering_in_frequency_domain_AIE_Blocks/kernels/apply_fd_taps.cpp
DOMAIN: DSP — FIR / Filtering
INTERFACE: Window
KEY INTRINSICS: aie::begin_vector, aie::set_saturation, aie::saturation_mode, aie::set_rounding, aie::rounding_mode, aie::vector, aie::accum, aie::mul
VECTOR TYPES: aie::vector<cint16,8>, aie::accum<cacc48,8>
*/
