...
PATH: Examples/AIENGINE/Farrow_Filter/aie/farrow_kernel1.cpp
DOMAIN: DSP — FIR / Filtering
INTERFACE: Window
KEY INTRINSICS: aie::set_rounding, aie::rounding_mode, aie::set_saturation, aie::saturation_mode, aie::accum, aie::vector, aie::load_v, aie::begin_vector, aie::sliding_mul_sym_xy_ops
VECTOR TYPES: aie::vector<cint16,16>, aie::vector<int16,16>, aie::accum<TT_ACC,8>, v8cint16
*/
