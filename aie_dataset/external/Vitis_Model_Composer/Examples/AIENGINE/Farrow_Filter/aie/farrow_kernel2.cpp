...
PATH: Examples/AIENGINE/Farrow_Filter/aie/farrow_kernel2.cpp
DOMAIN: DSP — FIR / Filtering
INTERFACE: Window
KEY INTRINSICS: aie::set_rounding, aie::rounding_mode, aie::set_saturation, aie::saturation_mode, aie::vector, aie::accum, aie::begin_vector, aie::begin_restrict_vector, aie::vector_cast, aie::mac, aie::from_vector
VECTOR TYPES: aie::vector<int16,8>, aie::accum<TT_ACC,8>
*/
