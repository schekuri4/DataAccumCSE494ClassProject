...
PATH: Examples/AIENGINE/Importing_AIE_blocks/AIE_Class_Kernel_FIR/src/aie_kernels/FirSingleStream.cpp
DOMAIN: DSP — FIR / Filtering
INTERFACE: Stream
KEY INTRINSICS: aie::accum, aie::vector, aie::load_v, aie::sliding_mul, aie::sliding_mac, aie::zeros, writeincr
VECTOR TYPES: aie::vector<cint16,8>, aie::vector<cint16,32>, aie::accum<cacc48,8>
*/
