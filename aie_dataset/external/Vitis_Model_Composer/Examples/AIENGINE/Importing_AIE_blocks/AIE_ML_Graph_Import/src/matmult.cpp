...
PATH: Examples/AIENGINE/Importing_AIE_blocks/AIE_ML_Graph_Import/src/matmult.cpp
DOMAIN: Matrix Operations / Linear Algebra
INTERFACE: Window
KEY INTRINSICS: aie::vector, aie::begin_vector, aie::mmul, tile
VECTOR TYPES: aie::vector<T,R*C>
*/
