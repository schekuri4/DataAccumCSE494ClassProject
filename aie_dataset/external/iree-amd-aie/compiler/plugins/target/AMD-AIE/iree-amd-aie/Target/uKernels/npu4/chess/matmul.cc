...
PATH: compiler/plugins/target/AMD-AIE/iree-amd-aie/Target/uKernels/npu4/chess/matmul.cc
DOMAIN: Matrix Operations / Linear Algebra
INTERFACE: Unknown
KEY INTRINSICS: aie::accum, aie::vector, aie::load_v, aie::concat, aie::detail, aie::bfp_vector, aie::mmul
VECTOR TYPES: aie::vector<T_in,32>, aie::vector<int8,size_A>, aie::vector<int8,size_B>, aie::accum<T_out,64>, aie::accum<T_out,32>, aie::accum<accfloat,64>, aie::accum<accfloat,32>, aie::accum<accfloat,size_A>, aie::accum<accfloat,size_B>, aie::accum<accfloat,size_C>
*/
