/*
SOURCE: nod-ai/iree-amd-aie, branch main
PATH: compiler/plugins/target/AMD-AIE/iree-amd-aie/Target/uKernels/npu4/chess/softmax.cc
DOMAIN: AIE Source
INTERFACE: Unknown
KEY INTRINSICS: aie::cbegin_vector, aie::begin_vector, aie::cbegin_restrict_vector, aie::begin_restrict_vector, aie::vector, aie::accum, aie::broadcast, aie::zeros, aie::mul, aie::exp2, aie::reduce_add, aie::inv
VECTOR TYPES: aie::vector<bfloat16,16>, aie::vector<bfloat16,SM_VEC_LEN>, aie::vector<float,SM_VEC_LEN>, aie::accum<accfloat,16>, aie::accum<accfloat,SM_VEC_LEN>
*/
