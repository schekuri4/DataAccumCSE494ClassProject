...
PATH: Pattern2_int8/src/kernels/kernels.cc
DOMAIN: AIE Source
INTERFACE: Window
KEY INTRINSICS: aie::mmul, aie::tile, aie::vector, aie::load_v, aie::store_v, aie::add, window_writeincr, dimensions, tile
VECTOR TYPES: aie::vector<int8,MMUL::size_A>, aie::vector<int8,MMUL::size_B>, aie::vector<int32,8>
*/
