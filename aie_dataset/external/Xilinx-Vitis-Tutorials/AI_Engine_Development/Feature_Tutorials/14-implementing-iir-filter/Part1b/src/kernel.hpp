...
PATH: AI_Engine_Development/Feature_Tutorials/14-implementing-iir-filter/Part1b/src/kernel.hpp
DOMAIN: DSP — FIR / Filtering
INTERFACE: Window
KEY INTRINSICS: aie::vector, aie::accum
VECTOR TYPES: aie::vector<float,8>, aie::vector<float,16>, aie::accum<accfloat,8>
*/
