...
PATH: AI_Engine_Development/Feature_Tutorials/14-implementing-iir-filter/Part2b/src/graph.hpp
DOMAIN: DSP — FIR / Filtering
INTERFACE: Window, PLIO/GMIO
KEY INTRINSICS: connect, runtime, tile
