...
PATH: AI_Engine_Development/Feature_Tutorials/14-implementing-iir-filter/Part2b/src/kernel.cpp
DOMAIN: DSP — FIR / Filtering
INTERFACE: Window
KEY INTRINSICS: aie::zeros, aie::concat, aie::load_v, aie::mac, aie::add, window_writeincr
VECTOR TYPES: v8float, v16float
*/
