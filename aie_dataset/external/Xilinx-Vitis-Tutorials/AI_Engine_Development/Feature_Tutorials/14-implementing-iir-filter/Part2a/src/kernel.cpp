...
PATH: AI_Engine_Development/Feature_Tutorials/14-implementing-iir-filter/Part2a/src/kernel.cpp
DOMAIN: DSP — FIR / Filtering
INTERFACE: Window
KEY INTRINSICS: aie::zeros, aie::concat, aie::load_v, aie::mac, aie::print, window_writeincr
