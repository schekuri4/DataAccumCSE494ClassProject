...
PATH: AI_Engine_Development/Feature_Tutorials/13-aie-performance-analysis/testcase_nofifo_hang/aie/graph.h
DOMAIN: AIE Source
INTERFACE: PLIO/GMIO
KEY INTRINSICS: connect, connect< stream >, runtime
