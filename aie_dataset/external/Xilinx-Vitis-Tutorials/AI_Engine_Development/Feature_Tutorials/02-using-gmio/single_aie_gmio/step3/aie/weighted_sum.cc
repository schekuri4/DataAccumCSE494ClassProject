...
PATH: AI_Engine_Development/Feature_Tutorials/02-using-gmio/single_aie_gmio/step3/aie/weighted_sum.cc
DOMAIN: GMIO / Data Movement
INTERFACE: Window
KEY INTRINSICS: aie::vector_decl_align, aie::vector, aie::load_v, aie::accum, aie::sliding_mul, window_writeincr
VECTOR TYPES: aie::vector<int32,8>, aie::vector<int32,16>, aie::accum<acc80,4>
*/
