...
PATH: AI_Engine_Development/Feature_Tutorials/02-using-gmio/perf_profile_aie_gmio/aie/vec_incr.cc
DOMAIN: GMIO / Data Movement
INTERFACE: Window
KEY INTRINSICS: aie::vector, aie::broadcast, aie::add, aie::tile, window_writeincr, tile
