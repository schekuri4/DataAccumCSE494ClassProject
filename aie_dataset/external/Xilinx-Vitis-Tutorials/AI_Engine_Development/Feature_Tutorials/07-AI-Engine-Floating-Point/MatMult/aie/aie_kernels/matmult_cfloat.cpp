...
PATH: AI_Engine_Development/Feature_Tutorials/07-AI-Engine-Floating-Point/MatMult/aie/aie_kernels/matmult_cfloat.cpp
DOMAIN: Matrix Operations / Linear Algebra
INTERFACE: Window
KEY INTRINSICS: window_writeincr
VECTOR TYPES: v8cfloat, v4cfloat, v16float, v8float, v32float
*/
