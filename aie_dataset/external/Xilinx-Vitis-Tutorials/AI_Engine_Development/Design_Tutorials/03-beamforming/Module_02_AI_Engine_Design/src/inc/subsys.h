...
PATH: AI_Engine_Development/Design_Tutorials/03-beamforming/Module_02_AI_Engine_Design/src/inc/subsys.h
DOMAIN: DSP — Beamforming
INTERFACE: Window, Cascade
KEY INTRINSICS: connect, connect<cascade>, runtime, location, bank, tile
