...
PATH: AI_Engine_Development/Design_Tutorials/03-beamforming/Module_02_AI_Engine_Design/src/kernels/bf8x8_fst.cc
DOMAIN: DSP — Beamforming
INTERFACE: Window, Stream
KEY INTRINSICS: mul4, mac4
VECTOR TYPES: v16cint16, v8cint16, v4cacc48
*/
