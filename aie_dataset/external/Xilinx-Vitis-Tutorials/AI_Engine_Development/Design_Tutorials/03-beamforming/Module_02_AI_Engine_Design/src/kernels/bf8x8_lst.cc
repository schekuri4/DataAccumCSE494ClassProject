...
PATH: AI_Engine_Development/Design_Tutorials/03-beamforming/Module_02_AI_Engine_Design/src/kernels/bf8x8_lst.cc
DOMAIN: DSP — Beamforming
INTERFACE: Window, Stream
KEY INTRINSICS: window_writeincr, mac4, srs
VECTOR TYPES: v16cint16, v8cint16, v8cacc48
*/
