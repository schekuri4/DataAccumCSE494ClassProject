...
PATH: AI_Engine_Development/Design_Tutorials/01-aie_lenet_tutorial/design/aie_src/core04.cc
DOMAIN: AIE Source
INTERFACE: Window
KEY INTRINSICS: aie::mmul, aie::vector, aie::load_v, aie::store_v, dimensions
VECTOR TYPES: aie::vector<int8_t,sizeTileA>, aie::vector<int8_t,sizeTileB>
*/
