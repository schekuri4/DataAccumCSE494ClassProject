...
PATH: AI_Engine_Development/Design_Tutorials/08-n-body-simulator/x10_design/aie/src/nbody.cc
DOMAIN: Simulation / N-Body
INTERFACE: Window
KEY INTRINSICS: window_writeincr, window_acquire, window_release
VECTOR TYPES: v8float
*/
