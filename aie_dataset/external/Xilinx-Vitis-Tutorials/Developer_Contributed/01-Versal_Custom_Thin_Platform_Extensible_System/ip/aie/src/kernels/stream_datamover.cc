...
PATH: Developer_Contributed/01-Versal_Custom_Thin_Platform_Extensible_System/ip/aie/src/kernels/stream_datamover.cc
DOMAIN: AIE Source
INTERFACE: Stream
KEY INTRINSICS: readincr_v4, writeincr_v4, upd_v
VECTOR TYPES: v16cint16
*/
