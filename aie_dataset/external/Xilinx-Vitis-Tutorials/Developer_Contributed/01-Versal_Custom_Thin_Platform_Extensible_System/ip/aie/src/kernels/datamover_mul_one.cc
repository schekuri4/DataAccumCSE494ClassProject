...
PATH: Developer_Contributed/01-Versal_Custom_Thin_Platform_Extensible_System/ip/aie/src/kernels/datamover_mul_one.cc
DOMAIN: AIE Source
INTERFACE: Window
KEY INTRINSICS: window_readincr, window_writeincr, srs
VECTOR TYPES: v16int16, v32cint16, v8cint16, v8cacc48
*/
