...
PATH: aie/single_aie_exp/aie_unconstr_buf/aie_i8_i16_64x184x64_api4x8x8/kernels/mm_kernel0.cc
DOMAIN: AIE Source
INTERFACE: Window
...
void mm_kernel0(input_buffer<int8> &__restrict matA,
                input_buffer<int8> &__restrict matB,
