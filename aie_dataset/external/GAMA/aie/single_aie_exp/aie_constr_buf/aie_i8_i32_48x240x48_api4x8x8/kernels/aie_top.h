...
PATH: aie/single_aie_exp/aie_constr_buf/aie_i8_i32_48x240x48_api4x8x8/kernels/aie_top.h
DOMAIN: AIE Source
INTERFACE: PLIO/GMIO
...
public:
    ...
    mm_graph() {
        ...
        location<buffer>(mm[0].in[1]) = {address(0, 0, 0x5100), address(0, 0, 0xD100)};
        location<buffer>(mm[0].out[0]) = {address(0, 0, 0x2D00), address(0, 0, 0xAD00)};
    }
};