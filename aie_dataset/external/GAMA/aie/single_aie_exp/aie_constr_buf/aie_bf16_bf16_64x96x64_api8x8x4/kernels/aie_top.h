...
PATH: aie/single_aie_exp/aie_constr_buf/aie_bf16_bf16_64x96x64_api8x8x4/kernels/aie_top.h
DOMAIN: AIE Source
INTERFACE: PLIO/GMIO
...
public:
    ...
    mm_graph() {
        ...
        location<kernel>(mm[0]) = tile(0, 0);
        location<buffer>(mm[0].in[0]) = {address(0, 0, 0x0000), address(0, 0, 0x8000)};
        location<buffer>(mm[0].in[1]) = {address(0, 0, 0x5000), address(0, 0, 0xD000)};
        location<buffer>(mm[0].out[0]) = {address(0, 0, 0x3000), address(0, 0, 0xB000)};
    }
};