...
PATH: aie/single_aie_exp/aie_constr_buf/aie_i8_i16_64x184x64_api4x8x8/kernels/aie_top.h
DOMAIN: AIE Source
INTERFACE: PLIO/GMIO
...
public:
    ...
    mm_graph() {
        ...
        location<buffer>(mm[0].in[1]) = {address(0, 0, 0x4E00), address(0, 0, 0xCE00)};
        location<buffer>(mm[0].out[0]) = {address(0, 0, 0x2E00), address(0, 0, 0xAE00)};
    }
};