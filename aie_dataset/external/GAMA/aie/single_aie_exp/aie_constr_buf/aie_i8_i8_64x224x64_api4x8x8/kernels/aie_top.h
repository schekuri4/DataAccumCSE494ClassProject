...
PATH: aie/single_aie_exp/aie_constr_buf/aie_i8_i8_64x224x64_api4x8x8/kernels/aie_top.h
DOMAIN: AIE Source
INTERFACE: PLIO/GMIO
...
public:
    ...
    mm_graph() {
        ...
        location<buffer>(mm[0].in[1]) = {address(0, 0, 0x4800), address(0, 0, 0xC800)};
        location<buffer>(mm[0].out[0]) = {address(0, 0, 0x3800), address(0, 0, 0xB800)};
    }
};