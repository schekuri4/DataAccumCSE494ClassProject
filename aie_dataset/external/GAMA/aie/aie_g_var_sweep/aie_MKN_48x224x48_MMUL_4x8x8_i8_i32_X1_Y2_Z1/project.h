...
PATH: aie/aie_g_var_sweep/aie_MKN_48x224x48_MMUL_4x8x8_i8_i32_X1_Y2_Z1/project.h
DOMAIN: AIE Source
                ...
                for (int i = 0; i < mult_Y; i++) {
                    ...
                    // Last AIE from the group
                        ...
                        location<buffer>(mat_mul_k[kernel_count].out[0]) = {
                            address(tile_x, tile_y, 0x2A00),
                            address(tile_x, tile_y, 0xAA00)};
                    }
                    ...
                    //     connect<>(A[plio_A].out[0], mat_mul_k[kernel_count].in[0]);
                    //     dimensions(mat_mul_k[kernel_count].in[0]) = {single_M *
                    //     single_K *
                    //                                                  1};
                    //     DEBUG(printf(
                    //         "PL-Kernel: A[%d] to kernel_%d_in0 with dimension %d \n",
                    ...
                    //     connect<>(B[plio_B].out[0], mat_mul_k[kernel_count].in[1]);
                    //     dimensions(mat_mul_k[kernel_count].in[1]) = {single_K *
                    //     single_N *
                    //                                                  1};
                    //     DEBUG(printf(
                    //         "PL-Kernel: B[%d] to kernel_%d_in1 with dimension %d \n",
                    ...
                    //     location<kernel>(mat_mul_k[kernel_count]) = tile(tile_x,
                    //     tile_y); runtime<ratio>(mat_mul_k[kernel_count]) = 1.0;
