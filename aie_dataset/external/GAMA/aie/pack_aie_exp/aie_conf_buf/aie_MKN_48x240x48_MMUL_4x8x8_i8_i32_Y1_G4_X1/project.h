...
PATH: aie/pack_aie_exp/aie_conf_buf/aie_MKN_48x240x48_MMUL_4x8x8_i8_i32_Y1_G4_X1/project.h
DOMAIN: AIE Source
            ...
            for (int k = 0; k < mult_X; k++) {
                ...
                for (int i = 0; i < mult_G; i++) {
                    ...
                    // Last AIE from the group
                        ...
                        //     address(tile_x - 1, tile_y, 0x7E00)};
                    }
                    ...
                    // sum
                        ...
                        // location<buffer>(mat_mul_k[kernel_count].in[0]) = {
                        //     address(tile_x, tile_y, 0x0000),
                        //     address(tile_x, tile_y, 0x5400)};
                        // location<buffer>(mat_mul_k[kernel_count].in[1]) = {
                        //     address(tile_x, tile_y, 0xA800),
                        //     address(tile_x, tile_y, 0xD200)};
                    }
