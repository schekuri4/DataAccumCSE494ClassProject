...
PATH: aie/pack_aie_exp/aie_unconstr_buf/aie_MKN_64x224x64_MMUL_4x8x8_i8_i8_X1_Y4_Z1/kernels/kernels.cc
DOMAIN: AIE Source
INTERFACE: Window
...
void vectorized_add(input_buffer<int16> &__restrict in_1,
                    input_buffer<int16> &__restrict in_2,
                    output_buffer<int16> &__restrict out)
{
    ...
    //cycle_num[1], (cycle_num[1] - cycle_num[0]));
}
