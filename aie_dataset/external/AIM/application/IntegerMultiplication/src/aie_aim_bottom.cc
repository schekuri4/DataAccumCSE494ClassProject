/*
SOURCE: arc-research-lab/AIM, branch main
PATH: application/IntegerMultiplication/src/aie_aim_bottom.cc
DOMAIN: AIE Source
INTERFACE: Window, Stream
KEY INTRINSICS: readincr_v4, writeincr_v4, srs
VECTOR TYPES: v16int32, v8int32, v8acc80
*/
