...
PATH: sources/matmult_lab/aie/src/aie_kernels/matmult_generic.h
DOMAIN: Matrix Operations / Linear Algebra
INTERFACE: Unknown
KEY INTRINSICS: aie::mmul, aie::load_v, aie::store_v, aie::vector
VECTOR TYPES: aie::vector<T,MMUL::size_A>, aie::vector<T,MMUL::size_B>
*/
