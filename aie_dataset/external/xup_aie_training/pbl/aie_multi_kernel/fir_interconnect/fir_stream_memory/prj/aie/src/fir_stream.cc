...
PATH: pbl/aie_multi_kernel/fir_interconnect/fir_stream_memory/prj/aie/src/fir_stream.cc
DOMAIN: DSP — FIR / Filtering
INTERFACE: Stream
KEY INTRINSICS: aie::vector, aie::load_v, aie::accum, aie::sliding_mul_xy_ops, aie::zeros, writeincr
