...
PATH: pbl/aie_multi_kernel/fir_interconnect/fir_stream_memory/prj/aie/src/fir_window.cc
DOMAIN: DSP — FIR / Filtering
INTERFACE: Window
KEY INTRINSICS: aie::vector, aie::load_v, aie::accum, aie::sliding_mul_xy_ops, aie::zeros, window_writeincr
VECTOR TYPES: aie::vector<int16,16>, aie::vector<int16,8>, aie::accum<acc48,AIE_MUL_LANES>
*/
