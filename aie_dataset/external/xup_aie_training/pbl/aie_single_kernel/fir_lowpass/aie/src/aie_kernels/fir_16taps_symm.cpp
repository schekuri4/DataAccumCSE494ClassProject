...
PATH: pbl/aie_single_kernel/fir_lowpass/aie/src/aie_kernels/fir_16taps_symm.cpp
DOMAIN: DSP — FIR / Filtering
INTERFACE: Window
KEY INTRINSICS: aie::sliding_mul_sym_xy_ops, aie::vector, aie::load_v, window_writeincr
VECTOR TYPES: aie::vector<int16,FIR_LEN>, aie::vector<cint16,32>
*/
