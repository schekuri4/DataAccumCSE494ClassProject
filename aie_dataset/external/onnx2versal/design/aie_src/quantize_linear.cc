...
PATH: design/aie_src/quantize_linear.cc
DOMAIN: AIE Source
INTERFACE: Window, Stream
KEY INTRINSICS: aie::accum, aie::broadcast, aie::mac, aie::vector, aie::mul, aie::add, readincr_v4, writeincr_v16, window_readincr, window_writeincr, upd_v
VECTOR TYPES: aie::vector<int32_t,16>, aie::vector<float,8>, aie::vector<int32,16>, aie::accum<acc48,16>, v16int32, v16acc48, v8float, v8int16, v8acc48
*/
