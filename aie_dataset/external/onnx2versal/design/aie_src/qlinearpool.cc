...
PATH: design/aie_src/qlinearpool.cc
DOMAIN: AIE Source
INTERFACE: Window, Stream
KEY INTRINSICS: aie::vector, aie::zeros, aie::broadcast, aie::accum, aie::reduce_add, aie::mac, readincr_v16, writeincr_v16, window_readincr, upd_v, srs
VECTOR TYPES: aie::vector<int16,16>, aie::vector<int16_t,16>, aie::accum<acc48,16>, v16int16, v128, v128int8, v128uint8, v32, v32int8, v32uint8
*/
