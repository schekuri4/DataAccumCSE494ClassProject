...
PATH: design/aie_src/gemm.cc
DOMAIN: Matrix Operations / Linear Algebra
INTERFACE: Window, Stream
KEY INTRINSICS: aie::mac, aie::vector, aie::accum, aie::max, aie::store_v, readincr, readincr_v4, window_readincr, window_writeincr, upd_v
VECTOR TYPES: aie::vector<float,8>, aie::accum<accfloat,8>, v8float, v16float
*/
