...
PATH: design/aie_src/dequantize_linear.cc
DOMAIN: AIE Source
INTERFACE: Window
KEY INTRINSICS: aie::accum, aie::broadcast, aie::vector, aie::mac, window_readincr, window_writeincr
VECTOR TYPES: aie::vector<int16_t,16>, aie::accum<acc48,16>, v16int32, v8int32, v8float
*/
