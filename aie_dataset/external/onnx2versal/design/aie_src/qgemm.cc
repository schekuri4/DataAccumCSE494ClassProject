...
PATH: design/aie_src/qgemm.cc
DOMAIN: Matrix Operations / Linear Algebra
INTERFACE: Stream
KEY INTRINSICS: aie::vector, aie::zeros, aie::broadcast, aie::accum, aie::add, aie::load_v, aie::mac, readincr_v16, writeincr_v16, upd_v
VECTOR TYPES: aie::vector<int16,16>, aie::accum<acc48,16>, v16, v16int8, v16uint8, v16int16, v128, v128int8, v128uint8, v64
*/
