...
PATH: design/aie_src/softmax.cc
DOMAIN: AIE Source
INTERFACE: Window
KEY INTRINSICS: aie::vector, aie::accum, aie::broadcast, aie::reduce_max, aie::zeros, aie::sub, aie::max, aie::mac, aie::mul_square, aie::add, aie::store_v, aie::reduce_add
VECTOR TYPES: aie::vector<float,8>, aie::accum<accfloat,8>, v16float, v8float
*/
