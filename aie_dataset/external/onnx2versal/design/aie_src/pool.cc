...
PATH: design/aie_src/pool.cc
DOMAIN: AIE Source
INTERFACE: Window
KEY INTRINSICS: aie::broadcast, aie::vector, aie::shuffle_down, aie::reduce_max, window_readincr, window_writeincr
VECTOR TYPES: aie::vector<int16_t,32>, aie::vector<int16_t,16>, aie::vector<TT,16>, v8float, v16float, v64int16, v16, v16int8, v16uint8, v32int16
*/
