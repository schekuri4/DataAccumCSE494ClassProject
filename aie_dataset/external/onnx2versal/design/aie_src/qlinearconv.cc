...
PATH: design/aie_src/qlinearconv.cc
DOMAIN: AIE Source
INTERFACE: Window, Stream
KEY INTRINSICS: aie::accum, aie::broadcast, aie::mac, aie::vector, aie::concat, aie::zeros, aie::filter_even, readincr_v16, readincr_v8, writeincr_v16, writeincr_v8, writeincr
VECTOR TYPES: aie::vector<int32_t,16>, aie::vector<int32_t,8>, aie::vector<int16,16>, aie::vector<int16_t,16>, aie::vector<TT,16>, aie::accum<acc48,16>, aie::accum<acc80,8>, aie::accum<acc48,8>, v64int8, v32int8
*/
