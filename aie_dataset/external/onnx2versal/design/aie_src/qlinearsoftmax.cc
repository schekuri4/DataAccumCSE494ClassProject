...
PATH: design/aie_src/qlinearsoftmax.cc
DOMAIN: AIE Source
INTERFACE: Window, Stream
KEY INTRINSICS: aie::vector, aie::accum, aie::broadcast, aie::mac, aie::mul_square, aie::add, aie::store_v, aie::zeros, aie::max, aie::reduce_max, aie::sub, aie::reduce_add
VECTOR TYPES: aie::vector<int16,16>, aie::vector<float,8>, aie::vector<int16_t,16>, aie::vector<TT,16>, aie::vector<int32_t,16>, aie::accum<accfloat,8>, aie::accum<acc48,16>, v16int16, v32int16, v16int32
*/
