...
PATH: design/aie_src/conv.cc
DOMAIN: AIE Source
INTERFACE: Window, Stream
KEY INTRINSICS: aie::broadcast, aie::vector, aie::accum, aie::mac, readincr, readincr_v4, writeincr, writeincr_v4, window_readincr, window_writeincr, upd_v
VECTOR TYPES: aie::vector<float,8>, aie::accum<accfloat,8>, v16float, v8float, v4float
*/
