...
PATH: design/aie_src/qlinearadd.cc
DOMAIN: AIE Source
INTERFACE: Stream
KEY INTRINSICS: aie::vector, aie::accum, aie::broadcast, aie::mac, aie::max, readincr_v16, writeincr_v16
VECTOR TYPES: aie::vector<int16_t,16>, aie::vector<TT,16>, aie::accum<acc48,16>
*/
