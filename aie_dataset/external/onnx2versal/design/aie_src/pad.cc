...
PATH: design/aie_src/pad.cc
DOMAIN: AIE Source
INTERFACE: Window, Stream
KEY INTRINSICS: aie::broadcast, aie::shuffle, aie::vector, aie::shuffle_down, aie::shuffle_down_replicate, aie::shuffle_up, aie::store_unaligned_v, readincr_v16, writeincr_v16, window_readincr, window_writeincr
VECTOR TYPES: aie::vector<int16_t,32>, aie::vector<int16_t,16>, aie::vector<TT,16>, v4float, v64int16, v16int8, v16uint8
*/
