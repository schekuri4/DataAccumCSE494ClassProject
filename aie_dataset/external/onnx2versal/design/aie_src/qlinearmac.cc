...
PATH: design/aie_src/qlinearmac.cc
DOMAIN: AIE Source
INTERFACE: Window, Stream
KEY INTRINSICS: aie::accum, aie::zeros, aie::load_v, aie::mac, aie::vector, aie::max, readincr_v16, writeincr_v16, window_readincr, window_writeincr
VECTOR TYPES: aie::vector<int16_t,16>, aie::vector<int32_t,16>, aie::vector<TT,16>, aie::accum<acc48,16>, v16, v16int8, v16uint8, v16acc48, v16int32
*/
