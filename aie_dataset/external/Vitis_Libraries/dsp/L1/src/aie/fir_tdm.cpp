...
PATH: dsp/L1/src/aie/fir_tdm.cpp
DOMAIN: DSP — FIR / Filtering
INTERFACE: Window, Cascade
KEY INTRINSICS: aie::vector, aie::accum, aie::begin_vector_random_circular, writeincr
VECTOR TYPES: aie::vector<TT_DATA,kSamplesInVectAcc>, aie::vector<TT_DATA,kSamplesInVectData>, aie::vector<TT_OUT_DATA,kSamplesInVectAcc>, aie::vector<TT_COEFF,kSamplesInVectCoeff>, aie::accum<typenametTDMAccBaseType<TT_DATA,TT_COEFF>
*/
