...
PATH: dsp/L1/src/aie/mixed_radix_twGen.cpp
DOMAIN: AIE Source
INTERFACE: Window
KEY INTRINSICS: aie::vector, aie::mul, runtime
VECTOR TYPES: aie::vector<T_ancillaryFields,kVectorSize>, aie::vector<TT_TWIDDLE,kTwVectorSize>, aie::vector<TT_TWIDDLE,kFanVectorSize>
*/
