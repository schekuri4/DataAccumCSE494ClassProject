...
PATH: dsp/L1/src/aie/euclidean_distance.cpp
DOMAIN: AIE Source
INTERFACE: Window
KEY INTRINSICS: aie::vector, aie::accum, aie::sub, aie::transpose, aie::mul_square, aie::mac_square, aie::zeros, aie::lut, aie::parallel_lookup, aie::lut_oor_policy, aie::broadcast, aie::bit_and
VECTOR TYPES: aie::vector<TT_DATA,kWregsize>, aie::vector<TT_DATA,kYregsize>, aie::vector<TT_DATA,m_kLanes>, aie::vector<TT_DATA,vecSize>, aie::accum<tEDAccType_t<TT_DATA>, aie::accum<accfloat,kSamples512bInFloatVec>, aie::accum<accfloat,kSamples1024bInFloatVec>, aie::accum<acc32,T_buff_1024b<int32>
*/
