...
PATH: dsp/L1/src/aie/kronecker.cpp
DOMAIN: AIE Source
INTERFACE: Window, Stream
KEY INTRINSICS: aie::vector, aie::accum, aie::mul, writeincr
VECTOR TYPES: aie::vector<TT_DATA_A,kSamplesInVectA>, aie::vector<TT_DATA_B,kSamplesInVectB>, aie::vector<out_t,kSamplesInVectOut>, aie::vector<out_t,kSamplesInVectTempOut>, aie::accum<acc_t,kVecSampleNumAcc>
*/
