...
PATH: dsp/L1/src/aie/conv_corr.cpp
DOMAIN: AIE Source
INTERFACE: Window, Stream, Cascade
KEY INTRINSICS: aie::vector, aie::mask, aie::zeros, aie::sliding_mul_ops, aie::reverse, aie::conj, aie::select, aie::accum, aie::vector_cast, readincr, writeincr, mac4
VECTOR TYPES: aie::vector<TT_DATA_OUT,m_kLanes>, aie::vector<TT_DATA_G,kVsize>, aie::vector<TT_DATA_F,kDataBuffLen>, aie::vector<TT_DATA_G,kCascVecSizeOfCoeff>, aie::vector<cint16,kShuffleVecSize>, aie::vector<TT_DATA_OUT,kLanes>, aie::accum<cacc48,(kLanes<<1)>, aie::accum<cacc48,kLanes>, v16
*/
