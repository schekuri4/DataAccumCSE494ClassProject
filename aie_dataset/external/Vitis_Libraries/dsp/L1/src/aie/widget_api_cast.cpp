...
PATH: dsp/L1/src/aie/widget_api_cast.cpp
DOMAIN: AIE Source
INTERFACE: Window, Stream, Cascade
KEY INTRINSICS: aie::vector, aie::interleave_zip, aie::concat, aie::filter_even, aie::filter_odd, aie::accum, aie::from_vector, writeincr
VECTOR TYPES: aie::vector<TT_DATA,kVectSize>, aie::vector<TT_DATA,kVectSize*2>, aie::vector<TT_DATA,kSamplesIn128b*2>, aie::vector<TT_DATA,kSamplesIn128b>, aie::vector<TT_DATA,kSamplesIn256b>, aie::vector<TT_DATA,kSamplesIn256b*2>, aie::vector<TT_DATA,kSamplesIn512b>, aie::accum<accTag,kCascVWidth>
*/
