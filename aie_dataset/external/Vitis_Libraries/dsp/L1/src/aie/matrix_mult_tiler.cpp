...
PATH: dsp/L1/src/aie/matrix_mult_tiler.cpp
DOMAIN: AIE Source
INTERFACE: Window
KEY INTRINSICS: aie::vector, aie::load_v, aie::store_v, aie::filter_even, aie::filter_odd, aie::concat, aie::transpose, tile
VECTOR TYPES: aie::vector<T_D,vectorSize>, aie::vector<T_D,vectorSize/2>, aie::vector<T_D,vectorSize/4>, aie::vector<T_D,loadSize>
*/
