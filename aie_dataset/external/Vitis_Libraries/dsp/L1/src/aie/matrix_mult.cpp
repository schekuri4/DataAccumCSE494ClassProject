...
PATH: dsp/L1/src/aie/matrix_mult.cpp
DOMAIN: AIE Source
INTERFACE: Window, Cascade
KEY INTRINSICS: aie::mmul, aie::vector, aie::load_v, aie::store_v, writeincr
VECTOR TYPES: aie::vector<TT_DATA_A,sizeTileA>, aie::vector<TT_DATA_B,sizeTileB>
*/
