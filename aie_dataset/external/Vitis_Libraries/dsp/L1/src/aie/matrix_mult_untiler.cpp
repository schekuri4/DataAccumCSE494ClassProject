...
PATH: dsp/L1/src/aie/matrix_mult_untiler.cpp
DOMAIN: AIE Source
INTERFACE: Window
KEY INTRINSICS: aie::vector, aie::load_v, aie::interleave_zip, aie::concat, aie::filter_even, aie::filter_odd, aie::transpose, aie::store_v, dimensions, tile
VECTOR TYPES: aie::vector<T_D,vectorSize>, aie::vector<T_D,vectorSize/2>
*/
