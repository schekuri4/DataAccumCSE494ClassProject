...
PATH: dsp/L1/src/aie/widget_real2complex.cpp
DOMAIN: AIE Source
INTERFACE: Window
KEY INTRINSICS: aie::vector, aie::zeros, aie::interleave_zip, aie::concat, aie::vector_cast, aie::filter_even
VECTOR TYPES: aie::vector<TT_DATA,128/8/sizeof(TT_DATA)>, aie::vector<TT_DATA,256/8/sizeof(TT_DATA)>, aie::vector<TT_OUT_DATA,256/8/sizeof(TT_OUT_DATA)>, aie::vector<TT_OUT_DATA,128/8/sizeof(TT_OUT_DATA)>
*/
