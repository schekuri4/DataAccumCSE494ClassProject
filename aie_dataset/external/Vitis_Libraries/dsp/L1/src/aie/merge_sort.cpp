...
PATH: dsp/L1/src/aie/merge_sort.cpp
DOMAIN: AIE Source
INTERFACE: Window, Stream, Cascade
KEY INTRINSICS: aie::vector, aie::broadcast, writeincr
VECTOR TYPES: aie::vector<TT_DATA,kSamplesInVec>, aie::vector<TT_DATA,kSamplesInWindowVec>
*/
