...
PATH: dsp/L1/src/aie/dft.cpp
DOMAIN: AIE Source
INTERFACE: Window, Cascade
KEY INTRINSICS: aie::vector, aie::accum, aie::zeros, aie::mac, writeincr
VECTOR TYPES: aie::vector<TT_DATA,kSamplesInVectData>, aie::vector<T_outDataType,kSamplesInVectData>, aie::vector<TT_TWIDDLE,kSamplesInVectData>, aie::accum<typenameaccType<T_outDataType,TT_TWIDDLE>
*/
