...
PATH: dsp/L1/src/aie/hadamard.cpp
DOMAIN: AIE Source
INTERFACE: Window, Stream
KEY INTRINSICS: aie::vector, aie::accum, aie::mul, writeincr, tile
VECTOR TYPES: aie::vector<TT_DATA_A,vecSampleNumA>, aie::vector<TT_DATA_B,vecSampleNumB>, aie::vector<out_t,vecSampleNumOut>, aie::vector<TT_DATA_A,vecSampleNumBuff>, aie::vector<TT_DATA_B,vecSampleNumBuff>, aie::vector<out_t,vecSampleNumBuff>, aie::vector<TT_DATA_A,kSamplesInVect>, aie::vector<TT_DATA_B,kSamplesInVect>, aie::vector<out_t,kSamplesInVect>, aie::accum<acc_t,vecSampleNumBuff>
*/
