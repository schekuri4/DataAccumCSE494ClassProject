...
PATH: dsp/L1/src/aie/fft_window.cpp
DOMAIN: DSP — FFT / Channelizer
INTERFACE: Window, Stream
KEY INTRINSICS: aie::vector, aie::accum, aie::mul, aie::zeros, writeincr, window_writeincr, location, tile
VECTOR TYPES: aie::vector<TT_DATA,kSamplesInVect>, aie::vector<TT_COEFF,kSamplesInVect>, aie::vector<TT_DATA,__ALIGN_BYTE_SIZE__/sizeof(TT_DATA)>, aie::vector<TT_DATA,kSamplesIn128b>, aie::accum<typenametAccBaseTypeMul<TT_DATA,TT_COEFF>, aie::accum<typenametAccBaseType<TT_DATA,TT_COEFF>
*/
