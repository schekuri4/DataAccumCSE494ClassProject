...
PATH: dsp/L1/src/aie/twiddle_rotator.cpp
DOMAIN: AIE Source
INTERFACE: Window
KEY INTRINSICS: aie::vector, aie::accum, aie::mul
VECTOR TYPES: aie::vector<TT_DATA,m_kNumDataLanes>, aie::vector<TT_TWIDDLE,m_kNumTwLanes>, aie::accum<typenametAccBaseTypeMul<TT_DATA,TT_TWIDDLE>
*/
