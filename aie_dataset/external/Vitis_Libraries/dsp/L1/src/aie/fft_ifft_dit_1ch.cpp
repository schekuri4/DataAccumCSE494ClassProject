...
PATH: dsp/L1/src/aie/fft_ifft_dit_1ch.cpp
DOMAIN: DSP — FFT / Channelizer
INTERFACE: Window, Stream, Cascade
KEY INTRINSICS: aie::vector, aie::accum, aie::zeros
VECTOR TYPES: aie::vector<TT_DATA,kSamplesInHeader>, aie::vector<TT_OUT_DATA,kSamplesInHeader>, aie::vector<TT_OUT_DATA,kSamplesOutHeader>, aie::vector<TT_OUT_DATA,koutVSize>, aie::accum<cacc48,kSamplesInHeader>
*/
