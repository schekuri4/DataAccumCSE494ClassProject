...
PATH: dsp/L1/src/aie/fir_sr_sym.cpp
DOMAIN: DSP — FIR / Filtering
INTERFACE: Window, Stream, Cascade
KEY INTRINSICS: aie::vector, aie::begin_random_circular, upd_v, bank
VECTOR TYPES: aie::vector<TT_DATA,kVsize>, aie::vector<TT_DATA,k128Vsize>, aie::vector<TT_DATA,k256Vsize>
*/
