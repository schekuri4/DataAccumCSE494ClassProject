...
PATH: dsp/L1/src/aie/func_approx.cpp
DOMAIN: AIE Source
INTERFACE: Window
KEY INTRINSICS: aie::vector, aie::accum, aie::downshift, aie::detail, aie::real, aie::imag, aie::bit_and, aie::from_vector, aie::mac, aie::to_fixed, aie::lut, aie::linear_approx
VECTOR TYPES: aie::vector<TT_DATA,kSamplesInVect>, aie::vector<complex_tt_data_t<TT_DATA>, aie::vector<int32,kSamplesInVect>, aie::accum<accType_t<TT_DATA>
*/
