...
PATH: dsp/L1/src/aie/dds_mixer.cpp
DOMAIN: AIE Source
INTERFACE: Window, Stream
KEY INTRINSICS: aie::vector, aie::sincos_complex, aie::mul, aie::accum, aie::op_conj, aie::mac, aie::conj, aie::to_float, aie::add, writeincr
VECTOR TYPES: aie::vector<TT_DATA,numLanes>, aie::vector<TT_DATA,m_kNumLanes>, aie::vector<T_LUT_TYPE,m_kNumLanes>, aie::vector<T_DDS_TYPE,m_kNumLanes>, aie::vector<cfloat,m_kNumLanes>, aie::accum<cacc64,m_kNumLanes>, aie::accum<cacc48,m_kNumLanes>, aie::accum<cacc80,m_kNumLanes>, aie::accum<cacc32,m_kNumLanes>, aie::accum<cacc64,4>
*/
