...
PATH: dsp/L1/src/aie/widget_2ch_real_fft.cpp
DOMAIN: DSP — FFT / Channelizer
INTERFACE: Window
KEY INTRINSICS: aie::vector, aie::accum, aie::conj, aie::reverse, aie::concat, aie::shuffle_up
VECTOR TYPES: aie::vector<TT_DATA,kVecSampleNum>, aie::vector<TT_DATA,2*kVecSampleNum>, aie::accum<cacc64,kVecSampleNum>
*/
