...
PATH: dsp/L1/src/aie/outer_tensor.cpp
DOMAIN: AIE Source
INTERFACE: Window, Stream
KEY INTRINSICS: aie::vector, aie::accum, aie::mul, writeincr
VECTOR TYPES: aie::vector<TT_DATA_A,vecSampleNumA>, aie::vector<TT_DATA_B,vecSampleNumB>, aie::vector<out_t,vecSampleNumTempOut>, aie::vector<out_t,vecSampleNumOut>, aie::accum<acc_t,vecSampleNumAcc>
*/
