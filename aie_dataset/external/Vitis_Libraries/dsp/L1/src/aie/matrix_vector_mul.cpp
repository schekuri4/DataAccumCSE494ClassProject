...
PATH: dsp/L1/src/aie/matrix_vector_mul.cpp
DOMAIN: AIE Source
INTERFACE: Window, Stream, Cascade
KEY INTRINSICS: aie::vector, aie::accum, aie::zeros, aie::mac, writeincr
VECTOR TYPES: aie::vector<TT_DATA_A,vecSampleNumA>, aie::vector<TT_DATA_B,vecSampleNumB>, aie::vector<TT_OUT,vecSampleNumA>, aie::vector<TT_OUT,vecSampleNumOut>, aie::vector<TT_DATA_B,streamLoadSize>, aie::vector<TT_DATA_B,streamVectorBuffSize>, aie::accum<typenameaccType<TT_DATA_A,TT_DATA_B>
*/
