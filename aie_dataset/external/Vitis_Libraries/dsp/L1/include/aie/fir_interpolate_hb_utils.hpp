...
PATH: dsp/L1/include/aie/fir_interpolate_hb_utils.hpp
DOMAIN: DSP — FIR / Filtering
INTERFACE: Unknown
KEY INTRINSICS: aie::accum, aie::vector, aie::interleave_zip, aie::concat, aie::from_vector, aie::api, aie::sliding_mul_sym_uct, aie::sliding_mul, aie::sliding_mac_sym_uct, aie::sliding_mac, aie::sliding_mac_sym, aie::sliding_mul_sym
VECTOR TYPES: aie::vector<T_D,2*fnNumLanes384<T_D,T_C>, aie::vector<T_D,2*m_kLanes>, aie::vector<TT_DATA,accLow.getLanes()/2>, aie::accum<typenametAccBaseType<T_D,T_C>, v4cacc80, v2cacc80
*/
