...
PATH: dsp/L1/include/aie/fir_decimate_hb_asym_utils.hpp
DOMAIN: DSP — FIR / Filtering
INTERFACE: Unknown
KEY INTRINSICS: aie::vector, aie::sliding_mac
VECTOR TYPES: aie::vector<TT_DATA,1024/8/sizeof(TT_DATA)>, aie::vector<TT_COEFF,256/8/sizeof(TT_COEFF)>
*/
