...
PATH: dsp/L1/include/aie/fir_decimate_asym_utils.hpp
DOMAIN: DSP — FIR / Filtering
INTERFACE: Unknown
KEY INTRINSICS: aie::sliding_mul_ops, aie::vector_cast, aie::vector, aie::interleave_unzip, readincr
VECTOR TYPES: aie::vector<TT_DATA,kSamplesIn512b>, aie::vector<TT_DATA,kSamplesIn256b>, aie::vector<TT_DATA,kSamplesIn128b>
*/
