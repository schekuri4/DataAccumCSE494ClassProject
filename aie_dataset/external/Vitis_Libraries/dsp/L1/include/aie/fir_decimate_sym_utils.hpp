...
PATH: dsp/L1/include/aie/fir_decimate_sym_utils.hpp
DOMAIN: DSP — FIR / Filtering
INTERFACE: Unknown
KEY INTRINSICS: aie::vector, aie::sliding_mul_sym_ops, aie::sliding_mul_ops
VECTOR TYPES: aie::vector<TT_DATA,kVectSize>
*/
