...
PATH: dsp/L1/include/aie/matrix_mult_tiler_common.hpp
DOMAIN: AIE Source
INTERFACE: Unknown
KEY INTRINSICS: aie::vector
VECTOR TYPES: aie::vector<T_D,Elems>, aie::vector<cint32,8>, aie::vector<int32,16>, aie::vector<cint16,16>, aie::vector<int16,32>, aie::vector<float,16>, aie::vector<cfloat,8>, aie::vector<T,Elems>
*/
