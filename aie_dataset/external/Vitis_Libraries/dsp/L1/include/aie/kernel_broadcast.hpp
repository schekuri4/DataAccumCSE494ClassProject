...
PATH: dsp/L1/include/aie/kernel_broadcast.hpp
DOMAIN: AIE Source
INTERFACE: Window, Cascade
KEY INTRINSICS: aie::vector, aie::begin_random_circular
VECTOR TYPES: aie::vector<int32,writesPerLoop>, aie::vector<int32,_32bsamplesInUnitWrite>, aie::vector<int32,samplesPerLoop>, aie::vector<int32,_32bSamplesPerBuffRead>, aie::vector<int32,_32bsamplesInUnitRead>
*/
