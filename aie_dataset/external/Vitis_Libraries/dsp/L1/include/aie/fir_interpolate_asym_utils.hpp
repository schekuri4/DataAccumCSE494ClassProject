...
PATH: dsp/L1/include/aie/fir_interpolate_asym_utils.hpp
DOMAIN: DSP — FIR / Filtering
INTERFACE: Stream
KEY INTRINSICS: aie::vector, aie::interleave_zip, writeincr
VECTOR TYPES: aie::vector<TT_DATA,kSamplesIn512b>, aie::vector<TT_DATA,kSamplesIn256b>, aie::vector<TT_DATA,kSamplesIn128b>, v64int16, v16int16, v32cint16, v8cint16, v32int32, v8int32, v4cint32
*/
