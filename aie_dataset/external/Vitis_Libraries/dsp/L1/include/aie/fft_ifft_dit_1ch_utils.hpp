...
PATH: dsp/L1/include/aie/fft_ifft_dit_1ch_utils.hpp
DOMAIN: DSP — FFT / Channelizer
INTERFACE: Stream, Cascade
KEY INTRINSICS: aie::fft_dit_r2_stage, aie::fft_dit, aie::begin_restrict_vector, aie::fft_dit_r4_stage, aie::vector, aie::interleave_zip, aie::concat, aie::accum, aie::filter_even, aie::filter_odd, aie::from_vector, writeincr
VECTOR TYPES: aie::vector<TT_DATA,kSamplesIn128b>, aie::vector<TT_DATA,kSamplesIn128b*2>, aie::vector<TT_DATA,kSamplesIn256b>, aie::vector<TT_DATA,kSamplesIn256b*2>, aie::accum<accTag,kCascVWidth>
*/
