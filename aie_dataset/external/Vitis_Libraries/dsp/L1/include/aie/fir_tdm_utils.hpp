...
PATH: dsp/L1/include/aie/fir_tdm_utils.hpp
DOMAIN: DSP — FIR / Filtering
INTERFACE: Cascade
KEY INTRINSICS: aie::accum, aie::vector, aie::mul, aie::mac, aie::concat, aie::zeros, writeincr
VECTOR TYPES: aie::vector<TT_DATA,samples>, aie::vector<TT_COEFF,samples>, aie::vector<cint16,16>, aie::vector<int16,16>, aie::vector<cint16,32>, aie::accum<typenametTDMAccBaseType<TT_DATA,TT_COEFF>, aie::accum<typenametTDMAccBaseType<cint16,int16>
*/
