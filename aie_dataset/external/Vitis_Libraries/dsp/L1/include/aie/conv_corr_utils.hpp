...
PATH: dsp/L1/include/aie/conv_corr_utils.hpp
DOMAIN: AIE Source
INTERFACE: Unknown
KEY INTRINSICS: aie::vector, aie::accum, aie::vector_cast, aie::conj
VECTOR TYPES: aie::vector<TT_DATA_F,1024/8/sizeof(TT_DATA_F)>, aie::vector<TT_DATA_F,512/8/sizeof(TT_DATA_F)>, aie::vector<TT_DATA_F,256/8/sizeof(TT_DATA_F)>, aie::vector<TT_DATA_F,128/8/sizeof(TT_DATA_F)>, aie::vector<TT_DATA_F,kVsize>, aie::vector<TT_DATA_G,(kMaxSamplesInShuffleVec/sizeof(TT_DATA_G))>, aie::vector<TT_DATA_G,kVsize>, aie::vector<TT_DATA_G,kVsize1>, aie::vector<int16,(kMinDataBuffLen<<1)>, aie::vector<cint16,kMinDataBuffLen>
*/
