...
PATH: dsp/L1/include/aie/kernel_api_utils.hpp
DOMAIN: AIE Source
INTERFACE: Window, Stream, Cascade
KEY INTRINSICS: aie::set_rounding, aie::rounding_mode, aie::set_saturation, aie::saturation_mode, aie::vectors, aie::vector, aie::zeros, aie::accum, aie::detail, aie::begin_random_circular, aie::random_circular_iterator, aie::begin_vector_random_circular
VECTOR TYPES: aie::vector<T,128/8/sizeof(T)>, aie::vector<T,256/8/sizeof(T)>, aie::vector<T,512/8/sizeof(T)>, aie::vector<T,1024/8/sizeof(T)>, aie::vector<TT_DATA,kVsize>, aie::vector<TT_DATA,256/8/sizeof(TT_DATA)>, aie::vector<TT_DATA,512/8/sizeof(TT_DATA)>, aie::vector<TT_DATA,1024/8/sizeof(TT_DATA)>, aie::vector<T_OutType,fnNumLanes<TT_DATA,TT_COEFF>, aie::vector<TT_DATA,fnNumLanes<TT_DATA,TT_COEFF>
*/
