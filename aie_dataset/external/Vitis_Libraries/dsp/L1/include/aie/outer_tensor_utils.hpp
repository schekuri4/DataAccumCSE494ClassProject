...
PATH: dsp/L1/include/aie/outer_tensor_utils.hpp
DOMAIN: AIE Source
INTERFACE: Unknown
KEY INTRINSICS: aie::vector, aie::accum
VECTOR TYPES: aie::vector<T_A,vecSampleNum<T_A,T_B>, aie::vector<T_B,vecSampleNum<T_A,T_B>, aie::vector<outTypeMult_t<T_A,T_B>, aie::accum<accTypeMult_t<T_A,T_B>
*/
