...
PATH: dsp/L1/include/aie/widget_2ch_real_fft_utils.hpp
DOMAIN: DSP — FFT / Channelizer
INTERFACE: Unknown
KEY INTRINSICS: aie::vector, aie::accum, aie::add, aie::mul, aie::sub
VECTOR TYPES: aie::vector<TT,vecSize>, aie::vector<cbfloat16,8>, aie::vector<cfloat,4>, aie::accum<cacc64,vecSize>
*/
