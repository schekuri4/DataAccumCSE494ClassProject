...
PATH: dsp/L1/include/aie/dds_mixer_utils.hpp
DOMAIN: AIE Source
INTERFACE: Window, Stream
KEY INTRINSICS: aie::accum, aie::vector, aie::mul, writeincr, window_writeincr
VECTOR TYPES: aie::vector<cint32,4>, aie::vector<cfloat,4>, aie::accum<cacc64,4>
*/
