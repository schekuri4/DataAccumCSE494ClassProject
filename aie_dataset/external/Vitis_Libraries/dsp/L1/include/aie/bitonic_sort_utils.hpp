...
PATH: dsp/L1/include/aie/bitonic_sort_utils.hpp
DOMAIN: AIE Source
INTERFACE: Unknown
KEY INTRINSICS: aie::vector, aie::transpose, aie::concat, aie::min, aie::max, aie::mask, aie::interleave_zip, aie::select, aie::reverse
VECTOR TYPES: aie::vector<TT,vecSize>, aie::vector<transposeType_t<row*col>, aie::vector<TT,64/sizeof(TT)>, aie::vector<int32,64/sizeof(int32)>, aie::vector<int16,64/sizeof(int16)>, aie::vector<TT_DATA,vecSize>, aie::vector<TT_DATA,vecSize/2>, aie::vector<TT_DATA,2*vecSize>
*/
