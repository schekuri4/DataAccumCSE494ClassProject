...
PATH: dsp/L1/include/aie/kernel_coeff_reload.hpp
DOMAIN: AIE Source
INTERFACE: Stream, Cascade
KEY INTRINSICS: aie::vector, aie::zeros, aie::not_equal, aie::mask, aie::neq, location
VECTOR TYPES: aie::vector<TT_COEFF,samplesPer256Buff>, aie::vector<TT_COEFF,samplesPerBuffWrite>, aie::vector<int32,MCD_SIZE/8/4>, aie::vector<int32,intsPerBuffRead>, aie::vector<int32,512/8/4>, aie::vector<TT_DATA,buffSize/8/sizeof(TT_DATA)>, aie::vector<TT_COEFF,buffSize/8/sizeof(TT_COEFF)>, aie::vector<TT_DATA,dataSamplesPer256Buff>, aie::vector<TT_COEFF,coeffSamplesPer256Buff>, aie::vector<int32,256/8/4>
*/
